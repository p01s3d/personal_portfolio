...
export const mix1Projects = [
  ...
  },
  {
    ...
    featuredSections: [
      ...
      {
        lead: 'The segmented control forcing users to choose denomination before intent was the single biggest source of drop-off.',
        richTitle: 'Pushing back on the brief',
        body: [
          'Once the mobile rebuild was underway, the brief itself needed pushing back on. Product benchmarking and heuristic evaluation surfaced a pattern no one had named: moving buy/sell intent before the amount screen eliminated it.',
          "Recurring trades had been buried at the summary screen — three steps too late. Surfacing them earlier required a structural change to the flow that the original brief hadn't scoped. Both decisions were validated through user testing before implementation — as the only designer on this work, that validation loop ran through one person, end to end.",
        ],
        images: ['/images/placeholder-mix1/ratio-686x868.svg', '/images/placeholder-mix1/ratio-686x868.svg'],
      },
      {
