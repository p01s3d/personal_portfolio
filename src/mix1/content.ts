    ...
    featuredSections: [
      {
        ...
        body: [
          'When I joined BlockFi as its first and only designer, I inherited a stack of problems, not one:',
          "— Mobile had no feature parity with web. You could log in, see your assets, and trade — but you couldn't view your Interest Account, opt into Rewards, manage a lost card, or access the Credit Card Rewards account.",
          '— There was no design system — no shared source of truth, which made it hard to keep web and mobile feeling coherent with each other, let alone with competitors.',
          '— Web itself was carrying significant design and technical debt, which slowed everything built on top of it.',
          "— The market had moved mobile-first — Coinbase and Robinhood were built for mobile first, web second — and BlockFi hadn't caught up.",
          '— There was no native mobile engineering partner to build against.',
          '— There was no prioritization infrastructure connecting user signal to what got built — no way to scope work against clear OKRs balanced by real user input.',
          '— There was no quarterly prioritization cadence — priorities were set without a consistent method for weighing effort against business goals.',
          '— There was no working definition of done: no release cadence, no documentation standards, no roadmap to hold work against.',
          '— Nothing was validated before engineering built it — testing happened after the fact, if at all.',
          "— Design had no formal partnership with security or compliance — a serious gap for a company holding other people's money, including institutional clients.",
          '— There were no design-originated product principles — nothing codified to hold the line when shipping pressure pushed against user trust or safety.',
          'Two UX-specific problems sat inside all of this: a segmented control forcing users to choose denomination before intent, which product benchmarking and heuristic evaluation surfaced as the single biggest source of drop-off, and recurring trades buried three steps too late, at the summary screen.',
        ],
        images: ['/images/placeholder-mix1/ratio-686x868.svg', '/images/placeholder-mix1/ratio-686x868.svg'],
      },
      {
